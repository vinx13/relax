...
def test_transform_params():
    ...
    class AfterLiftTransformParams:
        ...
        @R.function
        def transform_params(params : R.Tuple((R.Tensor((3, 16, 3, 3), "float32"),))) -> R.Tuple((R.Tensor((16, 3, 3, 3), "float32"),)):
            with R.dataflow():
                w1 = params[0]
                w1_transformed = R.call_tir(transform_layout_IOHW_to_OIHW, w1, R.Tensor((16, 3, 3, 3), "float32"))
        ...
        @R.function
        def main(x: R.Tensor((1, 3, 224, 224), "float32"), params: R.Tuple(R.Tensor((16, 3, 3, 3), "float32"),)) -> R.Tensor((1, 16, 224, 224), "float32"):
            # R.func_attr({})
            with R.dataflow():
                w1 = params[0]
